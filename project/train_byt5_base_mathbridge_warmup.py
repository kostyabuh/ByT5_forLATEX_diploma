...
TRAIN_PATH = Path(r"project\data\processed\mathbridge_50k_train.parquet")
VAL_PATH = Path(r"project\data\processed\mathbridge_50k_val.parquet")

MODEL_NAME = "google/byt5-base"
ARTIFACT_DIR = Path(r"project\artifacts\byt5_base_mathbridge_50k")
