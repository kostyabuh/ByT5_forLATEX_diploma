...
BASE_MODEL_DIR = Path(r"project\artifacts\byt5_base_mathbridge_50k\final_model")
ARTIFACT_DIR = Path(r"project\artifacts\byt5_base_mathbridge_ru_easy")
...
def main():
    ...
    if not BASE_MODEL_DIR.exists():
        raise FileNotFoundError(f"Базовая MathBridge-модель не найдена: {BASE_MODEL_DIR}")
