...
MODEL_DIR = Path(r"project\artifacts\byt5_base_mathbridge_ru_medium_clean_mixed_hardset\final_model")
HOLDOUT_PATH = Path(r"project\data\processed\s2l_ru_equations_medium_clean_holdout_100.parquet")
OUT_PATH = Path(r"project\artifacts\byt5_base_mathbridge_ru_medium_clean_mixed_hardset\holdout_100_eval.parquet")
