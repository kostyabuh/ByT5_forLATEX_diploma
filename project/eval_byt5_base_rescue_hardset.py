...
MODEL_DIR = Path(r"project\artifacts\byt5_base_mathbridge_ru_medium_clean_rescue\final_model")
VAL_PATH = Path(r"project\data\processed\s2l_ru_equations_medium_clean_val.parquet")
OUT_PATH = Path(r"project\artifacts\byt5_base_mathbridge_ru_medium_clean_rescue\eval_preview_100.parquet")
