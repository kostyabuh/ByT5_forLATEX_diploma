...
BASE_MODEL_DIR = Path(r"project\artifacts\byt5_base_mathbridge_ru_easy\final_model")
ARTIFACT_DIR = Path(r"project\artifacts\byt5_base_mathbridge_ru_medium_clean")
