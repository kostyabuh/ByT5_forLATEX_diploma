...
MODEL_DIR = Path(r"project\artifacts\byt5_s2l_ru_medium_clean\final_model")
VAL_PATH = Path(r"project\data\processed\s2l_ru_equations_medium_clean_val.parquet")
OUT_PATH = Path(r"project\artifacts\byt5_s2l_ru_medium_clean\eval_preview_100.parquet")
