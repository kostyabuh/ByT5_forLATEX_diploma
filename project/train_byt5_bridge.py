...
TRAIN_PATH = Path(r"project\data\processed\s2l_ru_equations_bridge_train.parquet")
VAL_PATH = Path(r"project\data\processed\s2l_ru_equations_bridge_val.parquet")

BASE_MODEL_DIR = Path(r"project\artifacts\byt5_s2l_ru_medium\final_model")
ARTIFACT_DIR = Path(r"project\artifacts\byt5_s2l_ru_bridge")
...
def main():
    ...
    if not BASE_MODEL_DIR.exists():
        raise FileNotFoundError(f"Базовая medium-модель не найдена: {BASE_MODEL_DIR}")
