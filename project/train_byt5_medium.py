...
TRAIN_PATH = Path(r"project\data\processed\s2l_ru_equations_medium_train.parquet")
VAL_PATH = Path(r"project\data\processed\s2l_ru_equations_medium_val.parquet")

BASE_MODEL_DIR = Path(r"project\artifacts\byt5_s2l_ru_easy\final_model")
ARTIFACT_DIR = Path(r"project\artifacts\byt5_s2l_ru_medium")
...
def main():
    ...
    if not BASE_MODEL_DIR.exists():
        raise FileNotFoundError(f"Базовая easy-модель не найдена: {BASE_MODEL_DIR}")
