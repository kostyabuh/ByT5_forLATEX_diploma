...
TRAIN_PATH = Path(r"project\data\processed\s2l_ru_equations_medium_clean_train.parquet")
VAL_PATH = Path(r"project\data\processed\s2l_ru_equations_medium_clean_val.parquet")

BASE_MODEL_DIR = Path(r"project\artifacts\byt5_base_s2l_ru_easy\final_model")
ARTIFACT_DIR = Path(r"project\artifacts\byt5_base_s2l_ru_medium_clean")
